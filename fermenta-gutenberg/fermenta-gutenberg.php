...
add_action('acf/init', function() {
  ...
  // 17 - news-post
  acf_register_block_type(array(
    'name'            => 'fermenta-block-17',
    'title'           => __('Block - 17'),
    'description'     => __('Новость'),
    'render_template' => 'fermenta-gutenberg/blocks/block-17.php',
    'category'        => 'block_fermenta',
    'icon'            => $icon,
    'keywords'        => array('fermenta'),
    'mode'            => 'preview',
  ...
  // 19 - store-product
  acf_register_block_type(array(
    'name'            => 'fermenta-block-19',
    'title'           => __('Block - 19'),
    'description'     => __('Товар'),
    'render_template' => 'fermenta-gutenberg/blocks/block-19.php',
    'category'        => 'block_fermenta',
    'icon'            => $icon,
    'keywords'        => array('fermenta'),
    'mode'            => 'preview',
